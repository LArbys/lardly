...
class LArFlowHitsPlotter(BasePlotter):
    """
    ...
    def __init__(self):
        """Initialize the LArFlowHits plotter"""
        super().__init__("LArFlowHits", "larflow hits")
        self._imports_successful = _IMPORTS_SUCCESSFUL
        self._input_trees_present = []
        logger.info(f"LArFlowHitsPlotter initialized. Imports successful: {self._imports_successful}")
    ...
    def is_applicable(self, tree_keys: List[str]) -> bool:
        ...
        if not self._imports_successful:
            logger.warning("LArFlowHitsPlotter not applicable: imports failed")
            return False
        ...
        logger.info(f"LArFlowHitsPlotter is applicable, found trees: {self._input_trees_present}")
        return True
    ...
    def make_option_widgets(self) -> List[Any]:
        ...
        return [
            html.Div([
                html.Label('LArFlowHits Options:'),
                
                html.Div([
                    html.Label('larflow3dhit Source:'),
                    dcc.Dropdown(
                        id='larflowhits-source',
                        options=[
                ...
                html.Div(id='larflowhits-conditional-options', children=[
    ...
    def get_option_component_ids(self):
        ...
        return [
            'larflowhits-source',
            'larflowhits-coloring-mode',
            'larflowhits-conditional-options',
            'larflowhits-particle-type',
            'larflowhits-keypoint-type',
            'larflowhits-plane-charge',
            'larflowhits-marker-size',
            'larflowhits-marker-opacity'
        ]
    ...
    def register_callbacks(self, app):
        ...
        try:
            ...
            @app.callback(
                Output('larflowhits-conditional-options', 'children'),
                [Input('larflowhits-coloring-mode', 'value')],
            ...
            @app.callback(
                ...
                [Input('larflowhits-source', 'value')],
                prevent_initial_call=True
            )
            ...
            @app.callback(
                Output('det3d-hidden-output', 'children', allow_duplicate=True),
                [Input('larflowhits-particle-type', 'value')],
                prevent_initial_call=True
            )
            ...
            @app.callback(
                Output('det3d-hidden-output', 'children', allow_duplicate=True),
                [Input('larflowhits-keypoint-type', 'value')],
                prevent_initial_call=True
            )
            ...
            @app.callback(
                Output('det3d-hidden-output', 'children', allow_duplicate=True),
                [Input('larflowhits-plane-charge', 'value')],
                prevent_initial_call=True
            )
            ...
            @app.callback(
                Output('det3d-hidden-output', 'children', allow_duplicate=True),
                [Input('larflowhits-marker-size', 'value')],
                prevent_initial_call=True
            )
            ...
            @app.callback(
                Output('det3d-hidden-output', 'children', allow_duplicate=True),
                [Input('larflowhits-marker-opacity', 'value')],
                prevent_initial_call=True
            )
            ...
            logger.info("LArFlowHitsPlotter callbacks registered successfully")
        except Exception as e:
            logger.error(f"Error registering LArFlowHitsPlotter callbacks: {e}")
            import traceback
            logger.error(traceback.format_exc())

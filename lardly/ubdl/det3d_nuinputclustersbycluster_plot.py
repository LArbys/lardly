...
def make_traces( tree_dict ):
    ...
    for inputtree in INPUT_TREES_PRESENT:        
        ...
        for icluster in range(nclusters):
            ...
            scolor="rgba(%d,%d,%d,1)"%(rcolor[0],rcolor[1],rcolor[2])
	        ...
	        "name":f"[{icluster}]",
                ...
                "marker":{"color":scolor,"size":1,"opacity":0.2}
            }
...
register_det3d_plotter("nuinputclustersbyclusters",are_products_present,make_plot_option_widgets,make_traces)
